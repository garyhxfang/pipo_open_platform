...
const runtimeCapabilities: RuntimeCapability[] = [
  ...
  { id: 'local', merchantId: 'm-10086', name: '本地支付方式', category: '支付方式', scene: 'PayNow / OVO / DANA', orders: 17086, traffic: 20757, successRate: 82.31, change: -3.8, status: 'attention', trend: [74, 70, 68, 65, 61, 63, 58] },
  ...
  { id: 'combined', merchantId: 'm-10086', name: '组合支付', category: '支付能力', scene: 'Credit + X', orders: 3690, traffic: 4198, successRate: 87.9, change: 2.1, status: 'healthy', trend: [60, 58, 64, 66, 65, 70, 72] },
...
const paymentMethodDetails: PaymentMethodDetail[] = [
  ...
  { id: 'paynow', parentId: 'local', name: 'PayNow', orders: 9046, traffic: 10570, successRate: 85.58, change: 2.6, status: 'healthy', trend: [62, 65, 64, 66, 67, 70, 72] },
  { id: 'ovo', parentId: 'local', name: 'OVO', orders: 4520, traffic: 5700, successRate: 79.3, change: -7.1, status: 'attention', trend: [75, 71, 68, 64, 59, 56, 53] },
  { id: 'dana', parentId: 'local', name: 'DANA', orders: 3520, traffic: 4487, successRate: 78.45, change: -5.4, status: 'attention', trend: [72, 69, 66, 63, 60, 58, 55] },
...
const paymentCapabilityDetails: PaymentMethodDetail[] = [
  ...
  { id: 'credit-plus-x', parentId: 'combined', name: 'Credit + X', orders: 3690, traffic: 4198, successRate: 87.9, change: 2.1, status: 'healthy', trend: [60, 58, 64, 66, 65, 70, 72] },
